...
const DOWNLOAD_LINKS = { android: { href: "https://download.itmanager.top/TrashVPN-1.1.5.apk", download: "TrashVPN.apk" }, windows: { href: "https://download.itmanager.top/TrashVPN-Setup-1.6-x64-1.exe" }, ios: { href: TESTFLIGHT_URL, label: "iOS（TestFlight）" }, macos: { href: TESTFLIGHT_URL, label: "macOS（TestFlight）" } };
